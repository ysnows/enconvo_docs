...
# Enconvo 2.2.21 Changelog (2025-11-25) 🚀
...
## OpenAI OAuth now supports additional models:
...
# Enconvo 2.2.20 Changelog (2025-11-23) 🚀
...
- Writing Tools now support using the language set in Profile, and support multiple language variants, such as US English or UK English
...
# Enconvo 2.2.19 Changelog (2025-11-22) 🚀
...
- Added region-specific language options (for example, you can now choose whether the LLM replies in American English or British English)
...
- Fixed incomplete reading of app content in Safari adaptation (added link reader)


<br/>


# Enconvo 2.2.18 Changelog (2025-11-08) 🚀
...
- Added an App Sidebar toggle and an option to hide the App Sidebar Handle icon for all apps in the right-click menu of the MenuBar and SideBar icons.
...
# Enconvo 2.2.14 Changelog (2025-09-11) 🚀
...
# Enconvo 2.2.13 Changelog (2025-09-05) 🚀
